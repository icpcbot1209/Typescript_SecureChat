...
var handleCreate = function handleCreate() {
  var _a = cryptoService.generateKeyPair(),
      pubkey = _a.pubkey,
      prikey = _a.prikey;
...
var showIt = function showIt(id) {
  var element = document.getElementById(id);
  element.style.display = "block";
};

var hideIt = function hideIt(id) {
  var element = document.getElementById(id);
...
var handleJoinConfirm = function handleJoinConfirm() {
...
var handleJoinCancel = function handleJoinCancel() {
  hideIt('join-modal');
  document.getElementById('paste-panel').value = '';
  initAppData();
};

var onReceiveMsg = function onReceiveMsg(msg) {
...
var addToChatList = function addToChatList(chat) {
